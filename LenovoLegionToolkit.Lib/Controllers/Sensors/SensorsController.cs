...
internal class SensorsController : ISensorsController
{
    ...
    {
        _controllerV1 = controllerV1 ?? throw new ArgumentException(nameof(controllerV1));
        _controllerV2 = controllerV2 ?? throw new ArgumentException(nameof(controllerV2));
        _controllerV3 = controllerV3 ?? throw new ArgumentException(nameof(controllerV3));
    }
