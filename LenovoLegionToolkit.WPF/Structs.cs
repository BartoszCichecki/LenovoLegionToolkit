...
public readonly struct DashboardGroup
{
    public static readonly DashboardGroup[] DefaultGroups =
    {
        ...
        new(DashboardGroupType.Other, null, DashboardItem.Microphone, DashboardItem.WhiteKeyboardBacklight, DashboardItem.PortsBacklight, DashboardItem.FlipToStart, DashboardItem.TouchpadLock, DashboardItem.FnLock, DashboardItem.WinKeyLock)
    };
