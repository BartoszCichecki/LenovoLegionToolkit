    ...
    public class NotificationsManager
    {
        ...
        private void OnNotificationReceived(Notification notification) => Dispatcher.Invoke(() =>
        {
            ...
            var text = notification.Type switch
            {
                ...
                NotificationType.SpectrumBacklightChanged => string.Format("Backlight {0}", notification.Args),
                NotificationType.SpectrumBacklightOff => string.Format("Backlight {0}", notification.Args),
