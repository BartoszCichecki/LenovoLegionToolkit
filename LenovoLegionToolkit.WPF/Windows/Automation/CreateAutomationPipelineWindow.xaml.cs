...
public partial class CreateAutomationPipelineWindow
{
    ...
    private CardAction CreateCardControl(IAutomationPipelineTrigger trigger)
    {
        var control = new CardAction
        {
            Icon = IconForTrigger(trigger),
            Content = new CardHeaderControl { Title = trigger.DisplayName },
            Margin = new(0, 8, 0, 0)
        };
