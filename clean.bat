...
rmdir /s /q LenovoLegionToolkit.CLI.Lib\bin
rmdir /s /q LenovoLegionToolkit.CLI.Lib\obj

rmdir /s /q LenovoLegionToolkit.Lib\bin
rmdir /s /q LenovoLegionToolkit.Lib\obj

rmdir /s /q LenovoLegionToolkit.Lib.AoTOSD\x64
rmdir /s /q LenovoLegionToolkit.Lib.AoTOSD\obj
